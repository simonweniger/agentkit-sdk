#
#  Be sure to run `pod spec lint agentkit.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://Agentkit.sh"
  ...
  spec.license      = { :type => "MIT", :file => "https://github.com/simonweniger/Agentkit-swift/blob/main/LICENSE" }
  ...
  spec.source       = { :git => "https://github.com/simonweniger/Agentkit-swift.git", :tag => spec.version.to_s }
