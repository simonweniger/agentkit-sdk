#
#  Be sure to run `pod spec lint superagent.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "http://superagent.sh"
  ...
  spec.license      = { :type => "MIT", :file => "https://github.com/simonweniger/superagent-swift/blob/main/LICENSE" }
  ...
  spec.author             = { "Simon Weniger" => "hello@simonweniger.com" }
  spec.social_media_url   = "https://twitter.com/SimonWeniger"
  ...
  spec.source       = { :git => "https://github.com/simonweniger/superagent-swift.git", :tag => spec.version.to_s }
